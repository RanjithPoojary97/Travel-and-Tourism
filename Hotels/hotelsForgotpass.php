<?php
    ...
    if(isset($_POST['h_forgotpass']))
    {
        $email=$_POST['email'];
        $mobile=$_POST['mobile'];
        $newpassword=md5($_POST['newpassword']);
        $sql ="SELECT hotel_pass FROM hotels WHERE hotel_email=:email and hotel_phone=:mobile";
        ...
        if($query -> rowCount() > 0)
        {
            $con = "update hotels set hotel_pass=:newpassword where hotel_email=:email and hotel_phone=:mobile";
...
<script type="text/javascript">
    function valid()
    {
        if(document.hforgot_pwd.newpassword.value!= document.hforgot_pwd.confirmpassword.value)
        {
            alert("New Password and Confirm Password do not match!!!");
            document.hforgot_pwd.confirmpassword.focus();
            return false;
        }
        return true;
    }
    ...
    <header>
                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    ...
                    <!-- Links -->
                        ...
                        {?>
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link"><?php echo ($_SESSION['hlogin']);?></a>
                                </li>
        ...
        <div id="bg-img">
            ...
            <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form class="form" name="hforgot_pwd" method="post" onsubmit="return valid();" autocomplete="on">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="h_forgotpass" class="btn btn-success float-right" style="width:90px;color:white;background-color:#3971a9;border-radius: 5px;border:transparent;font-family: sans-serif;font-size: 13px;">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
