<?php
    ...
    if(isset($_POST['hotelsLogin']))
    {
        $email=$_POST['email'];
        $password=md5($_POST['password']);
        $sql ="SELECT hotel_email,hotel_pass FROM hotels WHERE hotel_email=:email and hotel_pass=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        echo "<script type='text/javascript'> document.location = 'hotelsHome.php'; </script>";
    } else{
        ...
        <div class="row d-flex">
            <div class="col-lg-6">
                <div class="card1 pb-5">
                    ...
                    <div class="row px-3 justify-content-center mt-4 mb-5 border-line"> <img src="../images/Hotel-1.png" class="image"> </div>
                </div>
            </div>
            <div class="col-lg-6" >
                <div class="card2 card border-0 px-4 py-5" style="background-color: #e5e5e569;">
                    ...
                    <form name="hotels_login" method="post">
                    ...
                    <div class="row px-3 mb-4">
                        <div class="custom-control custom-checkbox custom-control-inline"> <input id="chk1" type="checkbox" name="chk" class="custom-control-input"> <label for="chk1" class="custom-control-label text-sm">Remember me</label> </div> <a href="hotelsForgotpass.php" class="ml-auto mb-0 text-sm">Forgot Password?</a>
                    </div>
                    <div class="row mb-3 px-3"> <button type="submit" name="hotelsLogin" class="btn btn-blue text-center">Login</button> </div>
                    </form>

                    <div class="row mb-4 px-3"> <small class="font-weight-bold">Haven't registered your Travels? <a class="text-danger" href="hotelsRegister.php">Register now</a></small> </div>
                </div>
            </div>
        </div>
