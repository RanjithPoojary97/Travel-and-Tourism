...
if(strlen($_SESSION['hlogin'])==0)
	{	
		...
		if(isset($_POST['changeHotelspass']))
		{
...
<script type="text/javascript">
    function valid()
    {
        if(document.changeHotel_pwd.newpassword.value!= document.changeHotel_pwd.confirmpassword.value)
        {
            alert("New Password and Confirm Password do not match!!!");
            document.changeHotel_pwd.confirmpassword.focus();
            return false;
        }
        return true;
    }
    ...
    <header>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
            ...
            <div class="container">
                ...
                <!-- Navbar brand -->
                <a class="navbar-brand" href="hotelsHome.php">Travels & Tourism</a>
        ...
        <div id="bg-img" style="height: inherit;">
            ...
            <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form class="form" name="changeHotel_pwd" method="post" onsubmit="return valid();" autocomplete="on">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="changeHotelspass" class="btn btn-success float-right" style="width:90px;color:white;background-color:#3971a9;border-radius: 5px;border:transparent;font-family: sans-serif;font-size: 13px;">Change</button>
                                </div>
                            </form>
                        </div>
                    </div>
