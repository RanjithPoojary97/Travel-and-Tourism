    ...
    <main class="mt-5">
        <div class="container">
            ...
            <section id="package-list" class="text-center grey-text">
				...
				<div class="col-md-12">
                    	<table class="table table-striped table-bordered" id="hotelsBookings">
                    		<thead>
                     			 <tr>
                           			<th>#</th>
                           			<th>Booking Id</th>
