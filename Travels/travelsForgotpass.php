<?php
    ...
    if(isset($_POST['t_forgotpass']))
    {
        $email=$_POST['email'];
        $mobile=$_POST['mobile'];
        $newpassword=md5($_POST['newpassword']);
        $sql ="SELECT travels_email FROM travels WHERE travels_email=:email and travels_phone=:mobile";
        ...
        if($query -> rowCount() > 0)
        {
            $con = "update travels set travels_pass=:newpassword where travels_email=:email and travels_phone=:mobile";
...
<script type="text/javascript">
    function valid()
    {
        if(document.tforgot_pwd.newpassword.value!= document.tforgot_pwd.confirmpassword.value)
        {
            alert("New Password and Confirm Password do not match!!!");
            document.tforgot_pwd.confirmpassword.focus();
            return false;
        }
        return true;
    }
    ...
    <header>
                ...
                <div class="collapse navbar-collapse" id="basicExampleNav">
                    ...
                    <!-- Links -->
                        ...
                        {?>
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link"><?php echo ($_SESSION['tlogin']);?></a>
                                </li>
        ...
        <div id="bg-img">
            ...
            <div class="card card-outline-secondary">
                        ...
                        <div class="card-body">
                            <form class="form" name="tforgot_pwd" method="post" onsubmit="return valid();" autocomplete="on">
                                ...
                                <div class="form-group">
                                    <button type="submit" name="t_forgotpass" class="btn btn-success float-right" style="width:90px;color:white;background-color:#3971a9;border-radius: 5px;border:transparent;font-family: sans-serif;font-size: 13px;">Save</button>
                                </div>
                            </form>
                        </div>
                    </div>
