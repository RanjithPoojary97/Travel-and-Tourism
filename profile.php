...
if(strlen($_SESSION['login'])==0)
	...
	$sql="update user set user_name=:name,phone=:mobile where email_id=:email";
...
{	?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" name="email" value="<?php echo htmlentities($result->email_id);?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label>Name</label>
                                    <input type="text" class="form-control" id="name" name="name" value="<?php echo htmlentities($result->user_name);?>" required="">
                                </div>
                                <div class="form-group">
                                    <label>Mobile no</label>
                                    <input type="text" class="form-control" id="mobile" name="mobile" value="<?php echo htmlentities($result->phone);?>" required="">
                                </div>
                             	<div class="form-group">
                             		<label><b>Registration Date : </b><?php echo htmlentities($result->reg_date);?></label>
                             	</div>
                             	<div class="form-group">
                             		<label><b>Last updation Date : </b><?php echo htmlentities($result->updation_date);?></label>
                             	</div>
<?php }} ?>

                                <div class="form-group">
                                    <button type="submit" name="profileSubmit" class="btn btn-success float-right" style="width:90px;color:white;background-color:#3971a9;border-radius: 5px;border:transparent;font-family: sans-serif;font-size: 13px;">Update</button>
                                </div>
                            </form>
                        </div>
                    </div>
