        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <?php 
                    $tid=intval($_GET['tid']);
                    $sql = "SELECT * FROM travels WHERE travels_id=:tid";
					...
					if($query->rowCount() > 0)
					{
						...
						{	?>
							<div class="form-group row">
									...
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->travels_name); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Mobile No :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->travels_phone); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Email id :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->travels_email); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Licence no :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->travels_licno); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Service to :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->service_to); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Seat Type :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->seat_type); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Travels Detail :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->travels_detail); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Registration Date :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->t_regdate); ?></span>
									</div>
								</div>
								<div class="form-group row">
									<label for="focusedinput" class="control-label col-sm-2" style=""><b>Updation Date :</b></label>
									<div class="col-sm-7">
									<span><?php echo htmlentities($result->t_updation); ?></span>
									</div>
								</div>
