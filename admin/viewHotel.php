...
{				?>		
						  <tr>
							...
							<td><?php echo htmlentities($result->hotel_id);?></td>
							<td><?php echo htmlentities($result->hotel_name);?></td>
							<td><?php echo htmlentities($result->hotel_email);?></td>
							<td><?php echo htmlentities($result->hotel_phone);?></td>
							<td><?php echo htmlentities($result->h_regdate);?></td>
							<td><a href="hotelsDetail.php?hid=<?php echo htmlentities($result->hotel_id);?>"><button type="button" class="btn btn-primary btn-block" >View</button></a></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
                    		</tbody>
                    	</table>
